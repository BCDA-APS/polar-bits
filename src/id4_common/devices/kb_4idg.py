...
# This is very similar to the h KB, but not the same motor numbers...


class Vertical(Device):
    ds_piezo = Component(EpicsMotor, "m4", labels=("motor",))
    ds_pico = Component(EpicsMotor, "m11")
    ds_capsensor = Component(EpicsSignalRO, "m16.RBV")

    us_piezo = Component(EpicsMotor, "m5", labels=("motor",))
