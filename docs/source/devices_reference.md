...
| `status_aps` | `StatusAPS` | (none) | APS machine status (current, mode) | `source`, `status`, `baseline` |
| `status_polar` | `Status4ID` | `S04ID-PSS:` | POLAR beamline PSS status | `status`, `baseline` |
| `srs810` | `LockinDevice` | `4idbSoft:SRS810:` | SRS-810 lock-in amplifier | `core`, `baseline` |
...
| Name | Class | EPICS Prefix | Description | Labels |
|------|-------|-------------|-------------|--------|
| `hhl_mirror` | `HHLMirror` | `4idHHLM:` | HHL (high-heat-load) toroidal mirror | `mirror`, `baseline` |
| `t_mirror` | `ToroidalMirror` | `4idbToro:` | Toroidal focusing mirror | `optics`, `mirror`, `baseline` |
| `wbslt` | `SlitDevice` (`wb_slit`) | `4idVDCM:` | White-beam slits (`hor, diag, pitch, yaw`) | `slit`, `baseline` |
| `monoslt` | `SlitDevice` (`jj_slits`) | `4idVDCM:` | Post-monochromator slits (`top, bot, out, inb`) | `slit`, `baseline` |
...
| Name | Class | EPICS Prefix | Description | Labels |
|------|-------|-------------|-------------|--------|
| `bslt` | `SlitDevice` (`jj_slits`) | `4idbSoft:` | 4IDB beam-defining slits (`top, bot, out, inb`) | `slit`, `baseline` |
| `bkb` | `KBMirror` | `4idbSoft:` | KB mirror pair | `optics`, `baseline` |
| `bfilter` | `APSFilter` (`filters_device`) | `4idbSoft:filter:` | Attenuator filter bank | `filter`, `baseline` |
| `btetramm` | `TetrAMMRO` | `4idbSoft:TetrAMM:` | TetrAMM quad-electrometer / XBPM | `detector`, `xbpm`, `baseline` |
| `bmag` | `Magnet2T` | `motor_prefix=4idb:`, `kepco_prefix=4idbSoft:BOP:PS1:` | 2T electromagnet + Kepco power supply | `magnet`, `baseline` |
...
| `gfilter` | `APSFilter` (`filters_device_avs`) | `4idPyFilter:FL1:` | Attenuator filter bank (4IDG) | `filter`, `baseline` |
...
| `temp_336_4idg` | `LakeShore336Device` | `4idgSoft:LS336:TC1:` | LakeShore 336 temperature controller (`temperature_setup("g")`) | `temperature`, `baseline` |
| `temp_340_4idg` | `LakeShore340Device` | `4idgSoftX:LS340:TC1:` | LakeShore 340 temperature controller (`temperature_setup("g-340")`) | `temperature`, `baseline` |
| `i0g` | `I04idg` | `4idgSoft:` | I0 monitor motors (4IDG) | `baseline` |
| `ringlight` | `Ringlight` | `RINGLIGHT:` | Ring light controller | `baseline` |
| `piezo_jena` | `PiezoJena` | `4idgSoftX:asyn_MOXA_G:2` | Piezo-Jena nanopositioner stage | `baseline` |
| `gmag` | `KepcoDevice` | `4idkepco:` | Kepco power supply | `baseline` |
| `comp` | `GEController` | `4idPace:PC1:` | High-pressure compression controller | `high pressure`, `baseline` |
| `decomp` | `GEController` | `4idPace:PC2:` | High-pressure decompression controller | `high pressure`, `baseline` |
...
| Name | Class | EPICS Prefix | Description | Labels |
|------|-------|-------------|-------------|--------|
| `magnet911` | `Magnet911` | `4idhSoft:` | 9T-1T-1T superconducting vector magnet (`temperature_setup("h-9T")` for the VTI) | `magnet`, `baseline` |
| `hkb` | `HKBDevice` | `4idhKB:` | KB mirror pair (4IDH) | `optics`, `kb`, `baseline` |
| `crl` | `CRLClass` | `4idPyCRL:CRL4ID:` | Compound refractive lens (CRL, shared 4IDG/4IDH; use `crl_setup("h")` to switch the offset) | `optics`, `track_energy`, `baseline` |
| `hslt` | `SlitDevice` (`jj_slits`) | `4idhSoft:` | 4IDH slits (`top, bot, out, inb`) | `slit`, `baseline` |
| `hfilter` | `APSFilter` (`filters_device_avs`) | `4idPyFilter:FL2:` | Attenuator filter bank (4IDH) | `filter`, `baseline` |
...
| `laser` | `VentusLaser` | `4idhSoft:LQE1:` | Ventus Q-switched laser (alignment / pump) | `baseline` |
