...
.. py:module:: id4_common.callbacks.apstools_spec_file_writer
...
.. py:data:: SPEC_TIME_FORMAT
   :value: '%a %b %d %H:%M:%S %Y'


.. py:data:: SCAN_ID_RESET_VALUE
   :value: 0


.. py:class:: SpecWriterCallback(filename=None, auto_write=True, RE=None, reset_scan_id=False)
   ...
   **Deprecated**: Use :class:`~apstools.callbacks.spec_file_writer.SpecWriterCallback2`.
   ...
   .. py:attribute:: buffered_comments


   .. py:attribute:: auto_write
      :value: True



   .. py:attribute:: uid_short_length
      :value: 8



   .. py:attribute:: write_new_header
      :value: False



   .. py:attribute:: spec_epoch
      :value: None



   .. py:attribute:: spec_host
      :value: None



   .. py:attribute:: spec_user
      :value: None
   ...
   .. py:attribute:: reset_scan_id
      :value: False



   .. py:attribute:: spec_filename
      :value: None
   ...
   .. py:method:: receiver(key, document)
   ...
   .. py:method:: prepare_scan_contents()
   ...
   .. py:method:: make_default_filename()

      generate a file name to be used as default



   .. py:method:: newfile(filename=None, scan_id=None, RE=None)
   ...
   .. py:method:: usefile(filename)

      read from existing SPEC data file



.. py:class:: SpecWriterCallback2(*args, **kwargs)

   Bases: :py:obj:`apstools.callbacks.callback_base.FileWriterCallbackBase`
   ...
   *New in apstools 1.7.0.*
   ...
   .. py:attribute:: file_epoch
      :value: None



   .. py:property:: spec_filename
   ...
   .. py:attribute:: write_new_file_header
      :value: True



   .. py:attribute:: write_new_scan_header
      :value: False



   .. py:attribute:: data_labels
      :value: None
   ...
   .. py:method:: write_file_header()

      Write file header to file, if needed.



   .. py:method:: write_scan_data_row(doc)

      Write row of scan data to file.



   .. py:method:: write_scan_end(doc)

      Write scan ending to file.



   .. py:method:: write_scan_header()

      Write scan header to file.



.. py:function:: spec_comment(comment, doc=None, writer=None)
