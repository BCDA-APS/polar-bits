id4_common.devices.huber_filter
===============================

.. py:module:: id4_common.devices.huber_filter
...
.. py:class:: SlotDevice(*args, slot=1, **kwargs)
...
.. py:class:: HuberFilter(prefix='', *, name, kind=None, read_attrs=None, configuration_attrs=None, parent=None, child_name_separator='_', connection_timeout=DEFAULT_CONNECTION_TIMEOUT, **kwargs)
