...
.. py:module:: id4_common.devices.ringlight
...
.. py:class:: PVANTEnumSignal(*args, pv_name, **kwargs)
   ...
   .. py:method:: wait_for_connection(timeout=5.0)

      Raise if the PV cannot be reached within ``timeout`` seconds.



.. py:class:: Ringlight(prefix, *, name='', labels=None, **kwargs)
