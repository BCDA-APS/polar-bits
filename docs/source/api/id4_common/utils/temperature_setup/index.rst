...
.. py:module:: id4_common.utils.temperature_setup
...
.. py:function:: temperature_setup(label=None, *, add_to_baseline=True)
   ...
   :type add_to_baseline: bool, optional
   :param Side effects:
   :param ------------:
   :param On success:
   :param sets the following attributes on ``__main__``:
   :param - ``tc`` — the resolved setpoint signal (movable).:
   :param - ``ts`` — the resolved readback signal (readable).:
   :param - ``TEMPERATURE_CONTROLLER`` — the active label string.:
