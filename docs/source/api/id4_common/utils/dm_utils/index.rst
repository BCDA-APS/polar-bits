...
.. py:function:: list_esafs(year=None, sector=STATION)
...
.. py:function:: dm_experiment_setup(experiment_name, esaf_id=None, users_name_list: list = None, title: str = None, **kwargs)
